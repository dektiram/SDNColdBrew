...
class TdbfCtlSwitchPortList {
	var $CTLID='TdbfCtlSwitchPortList';
	var $TDBFPARAM;
	var $CI;
	var $thisInParent;
	var $TDBFModel;
	...
	var $ExtIncludeFile=array(
								'js'=>array('myjs/TdbfFunctionCollection.js','myjs/TdbfCtlSwitchPortList.js'),
								'css'=>array('mycss/TdbfCtlSwitchPortList.css')
							);

	public function init(&$pCtlObj,&$thisInParent,$pUserInfo){
		//$this->CI =& get_instance();
		$this->CI =$pCtlObj;
		$pStrJSON=file_get_contents($this->CI->config->item('data_model_path').'SwitchPortList.tdbf');
